  ...
  <section class="services">
    ...
    <section class="haircuts">
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="150">
        ...
        <div class="collapse" id="multiCollapseExample1">
          <div class="card card-body">
            - Pura e eficaz.
            - Formulada com creatina monoidratada de alta qualidade.
            - Disponível em pó ou cápsulas.
            - Sem adição de substâncias desnecessárias.
          </div>
        </div>
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="250">
        ...
        <div class="haircut-info">
          <strong>Polivitamínico 30 Comp</strong>
        ...
        <div class="collapse" id="multiCollapseExample2">
          <div class="card card-body">
            - Formulação micronizada para melhor absorção.
            - Elogiada pela pureza e qualidade.
            - Disponível em várias formas (pó, comprimidos).
            - Passa por rigorosos padrões de controle de qualidade.
          </div>
        </div>
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="haircut-info">
          <strong>Whey Protein Iso 1kg</strong>
          ...
          <a href="pagar/pagamento.php"><button class="btn">R$ 150,00</button></a>

        </div>

        <div class="collapse" id="multiCollapseExample3">
          <div class="card card-body">
            - Isolado de proteína de soro de leite de alta pureza.
            - Baixo teor de gordura e carboidratos.
            - Absorção rápida e eficiente.
            - Indicado para quem busca uma fonte de proteína de rápida digestão.
          </div>
        </div>
    ...
    <section class="haircuts">
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="400">
        <img src="img/creatine2.png" alt="vitamina" />
        <div class="haircut-info">
          <strong>Top Whey 3W 1Kg</strong>
          ...
          <button class="btn" data-toggle="modal" data-target=".bd-example-modal-xl">R$ 160,00</button>
        </div>

        <div class="collapse" id="multiCollapseExample9">
          <div class="card card-body">
            - Concentrado de proteína de soro de leite.
            - Rica fonte de proteínas de alta qualidade.
            - Perfil equilibrado de aminoácidos.
            - Ideal para suporte geral à construção muscular.
          </div>
        </div>
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="haircut-info">
          <strong>Termogênico 120 Cap</strong>
          ...
          <button class="btn" data-toggle="modal" data-target=".bd-example-modal-xl"> R$ 130,00</button>
        </div>

        <div class="collapse" id="multiCollapseExample5">
          <div class="card card-body">
            - Fórmula potente para aumentar a termogênese.
            - Estimula o metabolismo e a queima de gordura.
            - Energia adicional para treinos intensos.
            - Em formato de comprimidos para conveniência.
          </div>
        </div>
      ...
      <div class="haircut" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="haircut-info">
          <strong>Vitamina C 30 Comp</strong>
        ...
        <div class="collapse" id="multiCollapseExample6">
          <div class="card card-body">
            - Suporte antioxidante para o sistema imunológico.
            - Estimula a produção de colágeno para pele saudável.
            - Formato conveniente em comprimidos.
            - Ideal para reforçar a ingestão diária de vitamina C.
          </div>
        </div>
